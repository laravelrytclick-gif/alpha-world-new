      ...
      <div className="relative z-10">
        ...
        <section className="bg-slate-50 py-20 lg:py-28">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <motion.button
                whileHover={{ scale: 1.02, boxShadow: "0 20px 40px -12px rgba(34, 197, 94, 0.4)" }}
                whileTap={{ scale: 0.98 }}
                className="bg-gradient-to-r from-green-500 to-green-600 text-white px-10 py-5 rounded-2xl font-bold text-lg shadow-lg transition-all duration-300"
              >
                Begin Your Journey
