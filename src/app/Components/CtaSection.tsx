    ...
    <section id="contact" className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24 text-center">
        ...
        <div className="flex flex-col items-center justify-center gap-4 sm:gap-6 sm:flex-row">
          <button 
            onClick={openModal}
            className="group rounded-full bg-gradient-to-r from-green-500 to-green-600 px-6 sm:px-8 lg:px-10 py-3 sm:py-4 text-base sm:text-lg font-bold text-white shadow-2xl transition-all hover:from-green-600 hover:to-green-700 focus:outline-none focus:ring-2 focus:ring-green-400 transform hover:scale-105"
          >
