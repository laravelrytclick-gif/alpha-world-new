      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center">
          ...
          <div className="relative mx-auto max-w-2xl mb-8">
            ...
            />
            <button className="absolute right-2 top-1/2 -translate-y-1/2 rounded-xl bg-gradient-to-r from-green-500 to-green-600 px-6 py-2 text-white font-semibold hover:from-green-600 hover:to-green-700 transition-all shadow-lg hover:shadow-xl hover:scale-105">
              Search
            </button>
          </div>
